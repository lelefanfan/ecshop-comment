...
?>
    ...
    <!--授权按钮-->
    <?php if ($this->_var['http_host'] != 'localhost'): ?>
...
<script>
  ...
  if(bindBtn){
    bindBtn.onclick = function(){
      ...
      var frame = main.contentWindow.document.getElementById('cloudFrame');
      var mask = main.contentWindow.document.getElementById('Mask');
      if(panel&&mask&&frame){
